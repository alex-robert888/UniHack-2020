    ...
    return (
        <section className="main-section-benefits">
            ...
            <section className="cards-section">
                <TheBenefitsSectionCard title="Tenant" text="Get any maintenance issues fixed 
                    ...
                    for a given price."/>
                <TheBenefitsSectionCard title="Landlord" text="Keep your tenants close, 
                    ...
                    business organized."/>
                <TheBenefitsSectionCard title="Contractor" text="Start picking-up jobs, 
